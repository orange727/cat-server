...
var _srcMessageJs = require('../src/Message.js');

var _srcMessageJs2 = _interopRequireDefault(_srcMessageJs);

//can't put it here: document is not defined
var info = function info() {
    var msg1 = _srcMessageJs2['default'].init();
    msg1.info('info');
};

var MessageExample = (function (_Component) {
    _inherits(MessageExample, _Component);

    function MessageExample() {
        _classCallCheck(this, MessageExample);

        _get(Object.getPrototypeOf(MessageExample.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(MessageExample, [{
        key: 'render',
...
},{"../src/Message.js":157,"react":156}],2:[function(require,module,exports){
/**
...
exports['default'] = {
	init: function init() {
		...
		message = _Notification2['default'].instance(container);
		return this;
	},
	info: function info(content) {
		var duration = arguments.length <= 1 || arguments[1] === undefined ? 3 : arguments[1];

		addNotice({ content: content, duration: duration }, 'info');
	},
	success: function success(content) {
		var duration = arguments.length <= 1 || arguments[1] === undefined ? 3 : arguments[1];

		addNotice({ content: content, duration: duration }, 'success');
	},
	warning: function warning(content) {
		var duration = arguments.length <= 1 || arguments[1] === undefined ? 3 : arguments[1];

		addNotice({ content: content, duration: duration }, 'warning');
	},
	danger: function danger(content) {
		var duration = arguments.length <= 1 || arguments[1] === undefined ? 3 : arguments[1];

		addNotice({ content: content, duration: duration }, 'danger');
	}
};
module.exports = exports['default'];

},{"./Notification":159,"react":156}],158:[function(require,module,exports){
'use strict';
...
var Notice = (function (_Component) {
	...
	_createClass(Notice, [{
		...
		value: function componentDidMount() {
			...
			//timer should be set to this or this.props ??
			console.log('setTimeout', this.props.content, this.props.children, this.props.duration);
		...
		key: 'render',
		value: function render() {
			var cls = 'alert alert-' + this.props['class'];
			var styles = {
				margin: '5px 0'
			};
...
var Notification = (function (_Component) {
	...
	//放在props里不合适，放在state里也不合适,不想它一变就触发

	_createClass(Notification, [{
		key: 'add',
		value: function add(notice) {
			console.log('add is called', notice);
			//unique-key then can be removed
			notice.id = this.genKey();
			var notices = this.state.notices;
			console.log('old', notices);
			console.log('new', notices.concat(notice));
			this.setState({
				notices: notices.concat(notice)
			});
			//在调试的时候，setState之后它没有变化！只有render的时候才能看到变化，这是啥bug!
		}
	}, {
		key: 'remove',
		...
		value: function render() {
			...
			var noticeNodes = this.state.notices.map(function (notice) {
				return _react2['default'].createElement(
					_Notice2['default'],
					{ key: notice.id, onClose: _this2.onClose.bind(_this2, notice.id), duration: notice.duration, 'class': notice.type },
					notice.content
				);
			});
			var styles = {
			...
			return _react2['default'].createElement(
				'div',
				{ className: 'notice-list', style: styles },
				noticeNodes
			);
		}
	}]);
...
/* instance */
Notification.instance = function (container) {
	if (Notification._instance) {
		...
		var notices = _react2['default'].render(_react2['default'].createElement(Notification, { notices: [] }), div);
		Notification._instance = notices;
		return notices;
	}
};
module.exports = exports['default'];

},{"./Notice":158,"react":156}],160:[function(require,module,exports){
